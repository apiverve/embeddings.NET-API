...
namespace APIVerve
{
    public class TextEmbeddingsAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/embeddings";
        ...
        public TextEmbeddingsAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public TextEmbeddingsAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TextEmbeddingsQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(TextEmbeddingsQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(TextEmbeddingsQueryOptions options)
        {
